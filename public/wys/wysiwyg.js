...
function generate_wysiwyg(textareaID) {
  ...
  toolbar2 += '<td>&nbsp;</td></tr></table>';  
	...
	var iframe = '<table cellpadding="0" cellspacing="0" border="0" style="background-color:white;width:' + wysiwygWidth + 'px; height:' + wysiwygHeight + 'px;border: 1px inset #222222;"><tr><td valign="top">\n'
