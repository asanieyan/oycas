...
module CalendarHelper
  ...
  def calendar(options = {}, &block)
    ...
    cal << %(<thead><tr class="#{options[:month_name_class]}"><th id='monthName' colspan="7">#{Date::MONTHNAMES[options[:month]]} #{options[:year]}</th></tr><tr class="#{options[:day_name_class]}">)
